...
;text_parche: db 'NO PREGUNTEN, ASI FUNCIONA'
;len_parche: equ $-text_parche
...
text_error_overflow: db 'ERROR! Overflow detectado en la instruccion para la operacion: ',0xa
...
deco_RS:
 ...
 shl rbx,3
        ;impr_texto 0,0  ; No sabemos porque, pero con esta vara bretea
        ;testX text_Sv0,len_Sv0
