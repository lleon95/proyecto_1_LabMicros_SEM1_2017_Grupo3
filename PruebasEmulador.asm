...
const_headers_size: equ $-const_headers_txt
  ...
  file_name db '/home/tec/Desktop/Github/proyecto_1_LabMicros_SEM1_2017_Grupo3/Experimentos_LuisLeon/testROM.bin'
...
_FormatoJ:
  ...
  not r13d					; Invertir para adquirir el jaddress
  and r13, rdx
  jmp _fetch ; DEBUG!!
